...
public class DimensionDataCommand {
	...
	private static int getLevelData(CommandContext<CommandSource> ctx, ServerWorld level, String filename, NBTPath path, int page) throws CommandSyntaxException {
